...
const fellows = [
    { 'Name': 'Enmanuel', 'Age': 19, 'Tag': '@edln', 'Favorite Color': 'blue' },
    { 'Name': 'Devonte', 'Age': 20, 'Tag': '@the_engineer', 'Favorite Color': 'purple' },
    { 'Name': 'Laisha', 'Age': 19, 'Tag': '@newJnewMe', 'Favorite Color': 'pink' },
    { 'Name': 'Cielo', 'Age': 19, 'Tag': '@enElCielo', 'Favorite Color': 'yellow' },
    { 'Name': 'Paul', 'Age': 21, 'Tag': '@paully', 'Favorite Color': 'red' },
];
